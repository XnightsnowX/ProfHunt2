...
public class ProfessorFeedback {
    ...
    public ProfessorFeedback(String prof, double attr1, double attr2, double attr3, double attr4, String comment, String user, int likes, String year, String semester, String date) {
        this.prof = prof;
        this.attr1 = attr1;
        this.attr2 = attr2;
        this.attr3 = attr3;
