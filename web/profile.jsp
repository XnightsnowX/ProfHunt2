            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <br>
                        <br>
                        <b>Number of Ratings:   </b> <%=modNewList.size()%>
                        <br>
                        <br>
                        <b>Average Grade:   </b> B+
                        <br>
                        ...
                        <div class="modal fade" id="rate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
                            <div class="modal-dialog" style="width:1000px" >
                                <div class="modal-content" width="1000">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            ...
                                            <table class="table table-bordered" style="table-layout: fixed">
                                                <tr>
                                                    ...
                                                    <td><input type="radio" name="usefulness" value="4">
                                                        9</td>
                                                    <td><input type="radio" name="usefulness" value="4">
                                                        10<br>Extremely Slack</td>
                                                    
                                                </tr>
                                                <tr>
                                                    <td><b>Easiness:</b></td>
                                                    <td><input type="radio" name="easiness" value="1"> 1<br>Extremely Hard</td>
                                                    ...
                                                    <td><input type="radio" name="easiness" value="4"> 5<br>Neutral</td>
                                                    ...
                                                    <td><input type="radio" name="easiness" value="5"> 10<br>Extremely Easy</td>
                                                </tr>
                                                <tr>
                                                    <td><b>Relevance:</b></td>
                                                    <td><input type="radio" name="easiness" value="1"> 1<br>Extremely Not Relevant</td>
                                                    <td><input type="radio" name="easiness" value="2"> 2</td>
                                                    <td><input type="radio" name="easiness" value="3"> 3</td>
                                                    <td><input type="radio" name="easiness" value="4"> 4</td>
                                                    <td><input type="radio" name="easiness" value="4"> 5<br>Neutral</td>
                                                    ...
                                                    <td><input type="radio" name="easiness" value="4"> 8</td>
                                                    <td><input type="radio" name="easiness" value="4"> 9</td>
                                                    <td><input type="radio" name="easiness" value="5"> 10<br>Extremely Relevant</td>
                                                </tr>                                                

                                            </table>
                                            <b>Grades obtained:</b> <input type="text" name="lname" disabled value="A"> <br><br> <b>Comments:</b><br><textarea rows="4" cols="90" name="comment" maxlength="500" required>
                                            </textarea> <br> 
                                        </form>                            
